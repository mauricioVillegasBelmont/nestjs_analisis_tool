...
import { FilterFromDocumentDto } from 'documents_environment/documents/dto/Select-document.dto';
import { SearchFromDocumentDto } from 'documents_environment/documents/dto/Search-document.dto';
...
export class DocumentsController {
  ...
  search(
    ...
    queryParams: SearchFromDocumentDto,
  ) {
  ...
  findAll(
    @Query(new ValidationPipe({ transform: true }))
    queryParams: FilterFromDocumentDto,
  ) {
    if (!queryParams.content) queryParams.content = false;
